...
import pe.edu.upc.logisticmaster.data.repository.UserRepositoryImpl
...
object AppModule {
    ...
    /** Repositorios */
    val userRepository: UserRepository    = UserRepositoryImpl(userApiService)
    val workerRepository: WorkerRepository  = WorkerRepositoryImpl(workerApiService)
    val taskRepository: TaskRepository    = TaskRepositoryImpl(taskApiService)
    val reserveRepository: ReserveRepository = ReserveRepositoryImpl(reserveApiService)
}
